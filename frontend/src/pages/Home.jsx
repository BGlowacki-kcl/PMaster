    ...
    <Stack ref={ref} className='h-screen flex bg-secondarysky1'>
      <WaitlistDialog open={waitlist} close={closeWaitlist} showNotification={showNotification} />
        ...
        <Box className="absolute h-full w-full">
          <img src="/illustrations/schedule.svg" className="absolute right-1/5 top-1/4 h-80 w-auto" alt="schedule" />
          ...
          <img src="/illustrations/star.png" className="absolute h-50 w-auto bottom-1/9 right-1/6" alt="star" />
        </Box>
